[
	...
	},
	{
		...
		"details": [
			...
			"Implemented all of the design specification and frontend interactivity for the web application our customers use to buy tickets.",
			"Developed an integration tool, which connected our Phabricator and Bitbucket workflow, to track tasks and release cycles."
		],
	...
	},
	{
		...
		"end": "2016-04-01",
		"details": [
			"Created an end-to-end solution for generation user metrics images per ride",
			"Developed features for frontend Angular webapp, internal CMS and API (Python)",
			"Investigated other spin cycles and botique fitness studios in the NYC"
		],
	...
	},
	{
		...
		"end": "2016-10-31",
		"details": [
			"Created functional prototype for the new Mobile User Interface project"
		],
	...
	},
	{
		...
		"details": [
			...
			"Create proof of concepts to help design team define specifications an immersive product detail pages.",
